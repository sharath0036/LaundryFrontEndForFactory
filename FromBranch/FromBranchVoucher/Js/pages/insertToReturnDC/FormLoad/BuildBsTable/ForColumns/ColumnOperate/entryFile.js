...
let jVarLocalFormatterFunc = (value, row, index) => {
    if (row.ItemDetails !==0) {
        return [
            `<a class="like btn btn-primary" href="./ReturnDCItems.html?VoucherRef=${row.pk}" title="Show">`,
    ...
    return [
        `<a class="like" href="./ReturninsertQrCode.html?VoucherRef=${row.pk}" title="Scan">`,
